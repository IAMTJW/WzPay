...
public class AlipayServiceTest extends BaseTest {
    ...
    public void tradeCreate(){
        ...
        tradeCreateModel.setOut_trade_no("344546345634dd57");
    ...
    public void tradePay(){
        ...
        tradeCreateModel.setAuth_code("288685160579868583");
        tradeCreateModel.setSubject("测试订单5");
        tradeCreateModel.setOut_trade_no("344546345634dd58");
        tradeCreateModel.setTotal_amount(100);
        tradeCreateModel.setAlipay_public_key("");
        tradeCreateModel.setApp_id(" 2019022763428343");
        tradeCreateModel.setUrl("https://openapi.alipaydev.com/gateway.do");
        tradeCreateModel.setNotify_url("http://localhost:8080");
        tradeCreateModel.setReturn_url("http://localhst:8080");
        tradeCreateModel.setRsa_private_key("");
    ...
    public void tradeClose(){
        ...
        tradeCloseModel.setOut_trade_no("344546345634dd57");
    ...
    public void tradeRefund(){
        ...
        tradeRefundModel.setOut_trade_no("344546345634dd56");
        tradeRefundModel.setRefund_amount(9);
        tradeRefundModel.setRefund_reason("退款3");
        tradeRefundModel.setOut_request_no(""+System.currentTimeMillis());
